...
def main():
    ...
    with (
        open(input_path / "data/day11-example.txt", "r", encoding="utf-8") as example,
        open(input_path / "data/day11-example_2.txt", "r", encoding="utf-8") as example2,
        open(input_path / "data/day11-input.txt", "r", encoding="utf-8") as input,
    ):
        example_lines = []
